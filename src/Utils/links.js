...
export const MENU_API=`${process.env.BACKEND_BASEURL}/api/dapi/menu/pl?page-type=REGULAR_MENU&complete-menu=true&lat=12.9715987&lng=77.5945627&restaurantId=`;

export const IMG_URL = "https://media-assets.swiggy.com/swiggy/image/upload/";
// One File can only have one default export 

// SO WE WILL USE NAMED EXPORT
